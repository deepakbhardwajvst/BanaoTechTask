      ...
      <div className="container py-5">
        <div className="row g-5">
          <div className="col-lg-3 col-md-6">
            <h4
              className="section-title ff-secondary text-start  fw-normal mb-4"
              style={{ fontFamily: "DMM", color: "black", fontSize: 18 }}
            >
              Hobbycue
            </h4>
        ...
        <div className="copyright">
          <div className="row">
            <div
              ...
              style={{ fontFamily: "DMM" }}
            >
              ©{" "}
              <a
                href="#home"
                className="border-bottom"
                style={{ color: "black", fontFamily: "DMM" }}
              >
                HobbyCue
              </a>
              , All Right Reserved.
            ...
            <div className="col-md-6 text-center text-md-end">
              <div className="footer-menu">
                <a href="#home" style={{ color: "black", fontFamily: "DMM" }}>
                  Home
                </a>
                <a href="#home" style={{ color: "black", fontFamily: "DMM" }}>
                  Cookies
