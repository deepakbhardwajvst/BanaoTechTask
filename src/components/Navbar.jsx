...
const CustomNavbar = () => {
  return (
    <Navbar bg="light" expand="lg" className="contain">
      <Navbar.Brand
        href="#home"
        style={{ display: "flex", alignItems: "center", marginInline: "15px" }}
      >
        <div
          style={{
        ...
        <div>
          <span
            style={{ fontSize: "30px", color: "#8064A2", fontFamily: "DMM" }}
          >
            hobbycue
          </span>
          <div
            style={{ fontSize: "10px", color: "#8064A2", fontFamily: "DMM" }}
          >
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        ...
        <Nav className="ml-auto">
          <Nav.Link href="/explore">
            <IoCompass
              style={{ marginRight: "5px", fontSize: "25px", color: "#8064A2" }}
            />
            <span style={{ color: "#8064A2", fontFamily: "DMM" }}>Explore</span>
            <IoChevronDownOutline
              style={{ marginRight: "20px", fontSize: "18px", color: "grey" }}
            />
          </Nav.Link>
          <Nav.Link href="/explore">
            <IoSparkles
              style={{ marginRight: "8px", fontSize: "22px", color: "#8064A2" }}
            />
