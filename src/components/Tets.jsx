  ...
  return (
    <div>
      <div style={tabContainerStyle}>
        <div style={selectedTab === "Sign In" ? selectedBorderStyle : unselectedBorderStyle} onClick={() => handleTabClick("Sign In")}>Sign In</div>
        <div style={selectedTab === "Join In" ? selectedBorderStyle : unselectedBorderStyle} onClick={() => handleTabClick("Join In")}>Join In</div>
      </div>
      ...
      <button style={{ ...buttonStyle, backgroundColor: '#6A0573' }}>Continue</button>
    </div>
  );
};
